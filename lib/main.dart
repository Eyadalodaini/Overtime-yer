...
class NotificationService {
  ...
  static Future<void> schedule() async {
    ...
    if (!Settings.instance.reminders) return;
    ...
    await notifications.zonedSchedule(
      1001,
      'تذكير بالساعات الإضافية',
      'هل عملت ساعات إضافية اليوم؟ لا تنسَ تسجيلها.',
      next,
      const NotificationDetails(
        android: AndroidNotificationDetails(
          'overtime_reminders',
          'تذكيرات الإضافي',
          channelDescription: 'تذكير يومي لإضافة ساعات العمل الإضافية',
...
String money(num value) =>
    '${NumberFormat('#,##0', 'ar').format(value.round())} ريال';

String fmtDate(String value) =>
    DateFormat('yyyy/MM/dd', 'ar').format(DateTime.parse(value));
